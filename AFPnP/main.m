...
%     end
    ...
    errofKDLT_=Kd-[focal_length,0,0;0,focal_length,0;0,0,1];
    ...
    tic;
    [u,v]=efficient_pnp_posit(x3d_h,x2d_h,focal_length);
    Xw_test_1=[0,0,0;1,0,0;0,1,0;0,0,1];
    U_test_1=[u(4),v(4);u(1:3),v(1:3)];
    [R_t_1, T_t_1] = classicPosit(U_test_1, Xw_test_1, focal_length);
    tim_epnp_test_1=toc;
    ...
    A=[f,0,0;0,f,0;0,0,1];
    A0=[focal_length,0,0;0,focal_length,0;0,0,1];
    ...
    errofKUnEpnp_=A-[focal_length,0,0;0,focal_length,0;0,0,1];
...
K_true=[focal_length,0,0;0,focal_length,0;0,0,1];
...
figure;
plot(t,Rep_epnp,'+',t,Rep_afpnp,'o',t,Rep_afufpnp,'*');
Rep_epnp
Rep_afpnp
Rep_afufpnp
